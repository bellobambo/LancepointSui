...
const Hero = () => {
  const profiles = [
    { id: 1, imgSrc: '/images/profile1.png', position: 'top-0 left-1/2 -translate-x-1/2', size: 'w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16' }, // Top center
    { id: 2, imgSrc: '/images/profile2.png', position: 'top-1/4 left-1/2 translate-x-8', size: 'w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16', isSelected: true }, // Top right with blue border
    { id: 3, imgSrc: '/images/profile3.png', position: 'top-1/3 right-0 -translate-x-4', size: 'w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20' }, // Right side
    { id: 4, imgSrc: '/images/profile4.png', position: 'bottom-1/4 right-1/4', size: 'w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16' }, // Bottom right
    { id: 5, imgSrc: '/images/profile5.png', position: 'bottom-0 left-1/2 -translate-x-1/3', size: 'w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20' }, // Bottom
    { id: 6, imgSrc: '/images/profile6.png', position: 'left-[10%] top-1/2', size: 'w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14' }, // Left side
    { id: 7, imgSrc: '/images/profile7.png', position: 'left-0 top-1/4', size: 'w-14 h-14 md:w-16 md:h-16 lg:w-18 lg:h-18' }, // Left top
  ];
    ...
    <div className="relative flex items-center justify-between flex-col md:flex-row py-8 sm:py-12 bg-transparent min-h-[400px] sm:min-h-[500px]">
      ...
      <div className="max-w-xs sm:max-w-sm md:max-w-lg mb-20 md:mb-0">
        ...
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
          <Link 
            href="/signup" 
            className="bg-black text-white flex align-center justify-center rounded-full px-6 sm:px-8 py-2 sm:py-3 font-medium hover:bg-transparent hover:text-black border hover:border-black transition duration-300 text-center"
          >
            Sign Up
          </Link>
          <Link 
            href="/launch" 
            className="bg-white border border-black text-black rounded-full px-6 sm:px-8 py-2 sm:py-3 text-sm font-medium hover:bg-black hover:text-white transition duration-300 text-center"
          >
            Launch
          </Link>
        </div>
